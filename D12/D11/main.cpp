    ...
    float x3, float y3, float x4, float y4)
{
    ...
    float dist = 0.0f; 
    dist = sqrtf(std::pow((x1 - centerX), 2) + std::pow((y1 - centerY), 2));
    if (dist > maxDist) {
        maxDist = dist;
    }
    ...
    dist = sqrtf(std::pow((x2 - centerX), 2) + std::pow((y2 - centerY), 2));
    if (dist > maxDist) {
        maxDist = dist;
    }
    // TODO: For vertex 3 (x3, y3)
    dist = sqrtf(std::pow((x3 - centerX), 2) + std::pow((y3 - centerY), 2));
    if (dist > maxDist) {
        maxDist = dist;
    }
    // TODO: For vertex 4 (x4, y4)
    dist = sqrtf(std::pow((x4 - centerX), 2) + std::pow((y4 - centerY), 2));
    if (dist > maxDist) {
        maxDist = dist;
    }
